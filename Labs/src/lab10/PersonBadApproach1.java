...
public class PersonBadApproach1 {
	...
	public PersonBadApproach1(String firstName, String lastName, String dateOfBirth) {
	...
	public PersonBadApproach1(String firstName, String lastName, String dateOfBirth, String address) {
		this.lastName = lastName;
		this.firstName = firstName;
		this.dateOfBirth = dateOfBirth;
